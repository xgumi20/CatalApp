...
public class rViewMyPostAdapt extends RecyclerView.Adapter<rViewMyPostAdapt.MyViewHolder> {
    ...
    public rViewMyPostAdapt(Context context, List<Details> detailsList, String userName) {
    ...
    @Override
    public void onBindViewHolder(@NonNull @NotNull rViewMyPostAdapt.MyViewHolder holder, int position) {
        ...
        fRef.child("contentsReact").addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                if (fbUser == null) {
                    if (snapshot.child(key).child("likes").hasChild(userName)) {
                        holder.likeImg.setImageResource(R.drawable.ic_baseline_thumb_up_24);
                    } else if (snapshot.child(key).child("dislikes").hasChild(userName)) {
                        holder.dislikeImg.setImageResource(R.drawable.ic_baseline_thumb_down_24);
                    }
                } else {
                    if (snapshot.child(key).child("likes").hasChild(finalFbID)) {
                        holder.likeImg.setImageResource(R.drawable.ic_baseline_thumb_up_24);
                    } else if (snapshot.child(key).child("dislikes").hasChild(finalFbID)) {
                        holder.dislikeImg.setImageResource(R.drawable.ic_baseline_thumb_down_24);
                    }
                }
            }
        ...
        holder.username.setOnClickListener(v->{
            ...
            }else if (fbUser == null && !userName.equals(contentUserName)){
